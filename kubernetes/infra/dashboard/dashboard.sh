...
start)
   ...
   kubectl apply -f ~/dashboard/dashboard.yaml >/dev/null 2>&1
   kubectl apply -f ~/dashboard/dashboard-sa-ro.yaml >/dev/null 2>&1
...
stop)
   ...
   kubectl delete -f ~/dashboard/dashboard.yaml >/dev/null 2>&1
   kubectl delete -f ~/dashboard/dashboard-sa-ro.yaml >/dev/null 2>&1
   echo $msgstopped
   ;;
